...
In a previous blog [post](/a-quest-for-fast-personalized-recommendation-part-i/), we introduce the problem of top-*K* recommendation retrieval using Matrix Factorization (MF). We also highlight the importance of indexing structures as a faster alternative to an exhaustive search in this context.
...
**Figure 1: MIPS-to-NNS Reduction Pipeline**
...
**Figure 2: Indexable Representation Learning Pipeline**
...
Have fun learning with [Preferred.AI](/)![](/uploads/2023/05/IMG_6640.jpg)

    ](/conferred-wisdom/)

    #### [Conferred With Wisdom at WSDM-23](/conferred-wisdom/)
...
![](/uploads/2018/06/kdd-sg_tutorial_20180609_brochure1.jpg)
    ...
    #### [KDD.SG Tutorial on Image Classification Using CNN](/kdd-sg-tutorial-on-image-classification-using-cnn/)

    June 6, 2018

![](/uploads/2019/02/20190121_cover.jpg)

    ](/aaai19-practice-talks/)

    #### [AI for Preference Learning: Sentiment, Comparison, and Recommendation](/aaai19-practice-talks/)
